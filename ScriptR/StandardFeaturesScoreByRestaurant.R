...
top10<-completeRanking[,2:length(completeRanking)-1]

top10.long<-melt(top10,id.vars="name")
ggplot(top10.long,aes(x=variable,y=value,fill=variable))+geom_bar(stat="identity",position="dodge")
fileName<-paste("CompleteRanking",names[1],sep = "")
